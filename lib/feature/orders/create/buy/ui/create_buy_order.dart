...
class _CreateBuyOrderPageState extends State<CreateBuyOrderPage> {
  ...
  // Widget buildStep(BuyOrderCreationStep state) => createOrderFlow(_cubit, state.step, state.product);
            ...
            child: Theme(
              ...
              child: Stepper(
                ...
                steps: [
                  ...
                  BuyProductInformationStep(state.step == 1, state.product, (BuyOrderProductInfo info) {
